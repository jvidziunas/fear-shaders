...
DECLARE_DESCRIPTION("This is the base refraction material.  Objects behind this material will be distorted based on viewing angle.  This material will fall back to a special view-dependent multiply material on DX8 hardware.");
