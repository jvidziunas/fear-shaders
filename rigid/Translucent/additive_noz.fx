...
DECLARE_DESCRIPTION("This a version of the additive material that renders on top of everything.");
DECLARE_DOCUMENATION("Shaders\\Docs\\additive_noz\\main.htm");
...
PSOutput Translucent_PS(PSData_Translucent IN)
{
	...
	OUT.Color = LinearizeAlpha( GetMaterialDiffuse(IN.DiffuseTexCoord) * IN.Color );
