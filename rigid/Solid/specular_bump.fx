...
DECLARE_DESCRIPTION("This is the standard specular material with a parallax bump mapping effect, based on the alpha channel of the tNormalMap texture.  It will fall back to the specular material on DX8 hardware.");
DECLARE_DOCUMENATION("Shaders\\Docs\\specular_bump\\main.htm");
