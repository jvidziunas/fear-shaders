...
DECLARE_DESCRIPTION("This is a diffuse material.");
...
float4 Point_PS(PSData_Point IN) : COLOR
{
	...
	return GetLitPixelColor(IN.LightVector, IN.EyeVector, 
		GetSurfaceNormal_Unit(IN.TexCoord), GetMaterialDiffuse(IN.TexCoord), float4(0,0,0,0), 
...
{
	return GetDirectionalLitPixelColor(normalize(IN.LightVector), IN.TexSpace, 1.0.xxx, GetSurfaceNormal_Unit(IN.TexCoord),
