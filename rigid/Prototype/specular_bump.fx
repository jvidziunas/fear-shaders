...
DECLARE_DESCRIPTION("This is the standard specular material with a parallax bump mapping effect, based on the alpha channel of the tNormalMap texture.");
DECLARE_DOCUMENATION("Shaders\\Docs\\specular\\main.htm");
DECLARE_PARENT_MATERIAL(0, "..\\solid\\specular.fx");
